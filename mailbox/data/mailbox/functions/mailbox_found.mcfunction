...
execute store result score @s mb_x run data get entity @e[tag=position,limit=1] Pos[0]
execute store result score @s mb_y run data get entity @e[tag=position,limit=1] Pos[1]
execute store result score @s mb_z run data get entity @e[tag=position,limit=1] Pos[2]
